...
for k in sorted(range(10,11),reverse=False):
    ...
    var_selectors = {
        ...
        "Greedy_min_in": Greedy(problem_data, method="min_in", penalty=None, solver="MOSEK")
    }
    heuristics = {
    ...
    for var_selector in var_selectors.keys():
        ...
        test_logger_ins = TestLogger(f"LogRegpy/tests/test_data/test_MADELON_MOSEK_{var_selector}_No Heuristic_{k}.csv")
...
# To run:
# python -m LogRegpy.tests.all_madelon_tests
